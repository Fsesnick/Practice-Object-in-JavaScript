...
function addEstoque(prod, quantidade){

  prod.estoque += quantidade;
  console.log(quantidade + " " + prod.nome + "(s) adicionada (s) ao estoque.");
  console.log(prod.estoque + " " +prod.nome + "(s) em estoque");
}

// 3. Call the addInventory() function

addEstoque(produto,3);
...
In this example, "chair" is the name of the product.
*/
function processarVenda(prod, quantidade){
  prod.estoque -= quantidade;
  console.log(quantidade + " " +prod.nome + " vendidas");
  return quantidade* prod.preco_unitario;
...
"Total sale: $20"
*/
console.log("Vendas totais: R$" + processarVenda(produto,3));

//processarVenda(produto,5);
